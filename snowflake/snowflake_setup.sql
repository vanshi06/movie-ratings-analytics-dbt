...
SHOW SCHEMAS IN NETFLIX_ANALYTICS_DB;
...
SELECT * FROM NETFLIX_ANALYTICS_DB.RAW.RAW_MOVIES;

SELECT * FROM NETFLIX_ANALYTICS_DB.RAW.RAW_RATINGS;

SELECT * FROM NETFLIX_ANALYTICS_DB.RAW.RAW_TAGS;

SELECT * FROM NETFLIX_ANALYTICS_DB.RAW.RAW_GENOME_SCORES;

SELECT * FROM NETFLIX_ANALYTICS_DB.RAW.RAW_GENOME_TAGS;

SELECT * FROM NETFLIX_ANALYTICS_DB.RAW.RAW_LINKS;
...
INSERT INTO NETFLIX_ANALYTICS_DB.RAW.RAW_RATINGS
    (userId, movieId, rating, timestamp)
VALUES
    (999, 1, 2.0, 10000000000);

    
    
SELECT 'APPEND' AS strategy, COUNT(*) AS row_count FROM NETFLIX_ANALYTICS_DB.STAGING.FCT_RATINGS_APPEND

UNION ALL

SELECT 'MERGE', COUNT(*) FROM NETFLIX_ANALYTICS_DB.STAGING.FCT_RATINGS_MERGE

UNION ALL

SELECT 'DELETE_INSERT', COUNT(*) FROM NETFLIX_ANALYTICS_DB.STAGING.FCT_RATINGS_DELETE_INSERT

UNION ALL

SELECT 'MICROBATCH', COUNT(*) FROM NETFLIX_ANALYTICS_DB.STAGING.FCT_RATINGS_MICROBATCH
...
SELECT COUNT(*) FROM NETFLIX_ANALYTICS_DB.STAGING.FCT_RATINGS_MICROBATCH;


-- ============================================================
-- 24. FINAL MART VALIDATION
-- ============================================================
